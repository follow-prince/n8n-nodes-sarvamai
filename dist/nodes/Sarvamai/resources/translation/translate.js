...
exports.translationTranslateDescription = void 0;
...
exports.translationTranslateDescription = [
    {
        ...
        description: 'The text to translate. Max 1 000 characters for mayura:v1 and 2 000 characters for sarvam-translate:v1.',
        routing: {
            send: {
                type: 'body',
                property: 'input',
    ...
    },
    {
        ...
        description: 'Source language of the input text. Use "Auto Detect" for automatic detection (mayura:v1 only).',
        routing: {
            send: {
                type: 'body',
    ...
    },
    {
        ...
        description: 'Tone/style of the translation. Only "Formal" is supported for sarvam-translate:v1.',
        routing: {
            send: {
                type: 'body',
                property: 'mode',
    ...
    },
    {
        ...
        description: 'Controls transliteration style of the output. Only supported for mayura:v1.',
        routing: {
            send: {
                type: 'body',
